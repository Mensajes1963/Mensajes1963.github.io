...
function _interopRequireDefault1(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

var _circlr = require('circlr');

var _circlrPers = _interopRequireDefault1(_circlr);

var el = document.querySelector('.rotationLis_Pers');
...
var camera = (0, _circlrPers['default'])(el).scroll(true);
